...
var transformDataType = function transformDataType(result, camelCase) {
  return result.map(function (data) {
    return {
      column: camelCase ? 'asdasd' : data.column_name,
...
exports.default = function (dbConfig, table, camelCase) {
